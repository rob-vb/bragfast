  ...
  "standard-browser": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "image", name: "image", x: 64, y: 302, width: 1072, height: 603, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorY: "top" },
        ...
        square: {
          objects: [
            { id: "image", type: "image", name: "image", x: 64, y: 438, width: 952, height: 700, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorY: "top" },
      ...
      formats: {
        landscape: {
          objects: [
            ...
            { id: "image", type: "image", name: "image", x: 449, y: 279, width: 303, height: 605, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorY: "top" },
            { id: "logo", type: "logo", name: "logo", x: 395, y: 24, width: 411, height: 64, opacity: 1, zIndex: 2, objectFit: "contain" },
          ],
        },
        square: {

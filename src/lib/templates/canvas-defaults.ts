      ...
      formats: {
        ...
        square: {
          objects: [
            ...
            { id: "logo", type: "logo", name: "logo", x: 64, y: 43, width: 360, height: 77, opacity: 1, zIndex: 4, objectFit: "contain", anchorX: "left" },
          ],
        },
        portrait: {
          objects: [
            ...
            { id: "logo", type: "logo", name: "logo", x: 64, y: 65, width: 731, height: 94, opacity: 1, zIndex: 4, objectFit: "contain", anchorX: "left" },
          ],
        },
      },
    },
      ...
      formats: {
        landscape: {
          objects: [
            ...
            { id: "logo", type: "logo", name: "logo", x: 64, y: 199, width: 418, height: 48, opacity: 1, zIndex: 4, objectFit: "contain", anchorX: "left" },
          ],
        },
        square: {
          objects: [
            ...
            { id: "logo", type: "logo", name: "logo", x: 59, y: 311, width: 406, height: 48, opacity: 1, zIndex: 4, objectFit: "contain", anchorX: "left" },
          ],
        },
        portrait: {
          objects: [
            ...
            { ...textObj("description", { lineHeight: 1.5 }), x: 48, y: 944, width: 458, height: 899, fontSize: 32, zIndex: 3 },
            { id: "logo", type: "logo", name: "logo", x: 48, y: 672, width: 431, height: 48, opacity: 1, zIndex: 4, objectFit: "contain", anchorX: "left" },
          ],
        },
      },
    },

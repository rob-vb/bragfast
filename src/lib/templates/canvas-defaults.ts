  ...
  "standard-browser": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 64, y: 302, width: 1072, height: 603, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        square: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 64, y: 438, width: 952, height: 700, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        portrait: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 64, y: 473, width: 952, height: 915, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorX: "left", anchorY: "top" },
  ...
  "standard-mobile": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 449, y: 279, width: 303, height: 605, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorX: "left", anchorY: "top" },
            { id: "logo", type: "logo", name: "logo", x: 395, y: 24, width: 411, height: 64, opacity: 1, zIndex: 2, objectFit: "contain" },
        ...
        square: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 340, y: 524, width: 401, height: 803, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        portrait: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 288, y: 539, width: 505, height: 1050, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorX: "left", anchorY: "top" },
            { id: "logo", type: "logo", name: "logo", x: 64, y: 36, width: 731, height: 54, opacity: 1, zIndex: 2, objectFit: "contain", anchorX: "left" },
  ...
  "split-browser": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 630, y: 64, width: 643, height: 547, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        square: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 556, y: 96, width: 1009, height: 890, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        portrait: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 589, y: 64, width: 1041, height: 1222, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorX: "left", anchorY: "top" },
  ...
  "split-mobile": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 730, y: 48, width: 390, height: 700, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        square: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 570, y: 80, width: 460, height: 1100, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorX: "left", anchorY: "top" },
        ...
        portrait: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 707, y: 140, width: 550, height: 1070, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorX: "left", anchorY: "top" },
  ...
  "hero": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 0, y: 0, width: 1200, height: 675, opacity: 0.6, zIndex: 0, imageFrame: "none", objectFit: "cover" },
        ...
        square: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 0, y: 0, width: 1080, height: 1080, opacity: 0.6, zIndex: 0, imageFrame: "none", objectFit: "cover" },
        ...
        portrait: {
          objects: [
            { id: "image", type: "visual", name: "image", x: 0, y: 0, width: 1080, height: 1350, opacity: 0.6, zIndex: 0, imageFrame: "none", objectFit: "cover" },

  ...
  "standard-browser": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "image", name: "image", x: 64, y: 302, width: 1072, height: 603, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorY: "top", kenBurns: true },
            { id: "logo", type: "logo", name: "logo", x: 395, y: 24, width: 411, height: 64, opacity: 1, zIndex: 2, objectFit: "contain" },
            { id: "title", type: "text", name: "title", x: 64, y: 102, width: 1072, height: 89, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 90, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "center", verticalAlign: "bottom", color: "#F8AF3C", previewText: "Text goes here", textFit: false },
        ...
        square: {
          objects: [
            { id: "image", type: "image", name: "image", x: 64, y: 438, width: 952, height: 700, opacity: 1, zIndex: 1, imageFrame: "browser", imageFrameColor: "#E8E8E8", objectFit: "contain", anchorY: "top", kenBurns: true },
            { id: "logo", type: "logo", name: "logo", x: 64, y: 48, width: 360, height: 64, opacity: 1, zIndex: 2, objectFit: "contain", anchorX: "left" },
            { id: "title", type: "text", name: "title", x: 64, y: 142, width: 952, height: 120, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 90, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C", previewText: "Text goes here", textFit: false },
        ...
        portrait: {
          objects: [
            { id: "title", type: "text", name: "title", x: 64, y: 142, width: 952, height: 120, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 90, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C", previewText: "Text goes here", textFit: false },
            { id: "description", type: "text", name: "description", x: 64, y: 286, width: 952, height: 340, opacity: 0.8, zIndex: 4, fontFamily: "Plus Jakarta Sans", fontSize: 48, fontWeight: 400, letterSpacing: 0, lineHeight: 1.5, textAlign: "left", verticalAlign: "top", textFit: false },
            ...
            { id: "logo", type: "logo", name: "logo", x: 64, y: 48, width: 731, height: 64, opacity: 1, zIndex: 2, objectFit: "contain", anchorX: "left" },
          ],
        },
      },
    },
  ...
  "standard-mobile": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "title", type: "text", name: "title", x: 64, y: 109, width: 1072, height: 89, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 90, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "center", verticalAlign: "bottom", color: "#F8AF3C" },
            ...
            { id: "image", type: "image", name: "image", x: 449, y: 279, width: 303, height: 605, opacity: 1, zIndex: 1, imageFrame: "mobile", imageFrameColor: "#1A1A1A", objectFit: "contain", anchorY: "top", kenBurns: true },
            { id: "logo", type: "logo", name: "logo", x: 395, y: 24, width: 411, height: 64, opacity: 1, zIndex: 2, objectFit: "contain" },
          ],
        },
        square: {
          objects: [
            { id: "title", type: "text", name: "title", x: 64, y: 142, width: 952, height: 120, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 90, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C" },
        ...
        portrait: {
          objects: [
            { id: "title", type: "text", name: "title", x: 64, y: 142, width: 952, height: 120, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 90, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C" },
            { id: "description", type: "text", name: "description", x: 64, y: 277, width: 952, height: 376, opacity: 0.8, zIndex: 4, fontFamily: "Plus Jakarta Sans", fontSize: 48, fontWeight: 400, letterSpacing: 0, lineHeight: 1.5, textAlign: "left", verticalAlign: "top" },
  ...
  "split-browser": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "title", type: "text", name: "title", x: 64, y: 179, width: 502, height: 162, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 72, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C", previewText: "Text goes here" },
        ...
        square: {
          objects: [
            { id: "title", type: "text", name: "title", x: 55, y: 224, width: 433, height: 340, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 72, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C", previewText: "Text goes here" },
        ...
        portrait: {
          objects: [
            ...
            { id: "title", type: "text", name: "title", x: 48, y: 325, width: 458, height: 601, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 72, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C", previewText: "Text goes here" },
            { id: "description", type: "text", name: "description", x: 48, y: 944, width: 458, height: 899, opacity: 1, zIndex: 4, fontFamily: "Plus Jakarta Sans", fontSize: 32, fontWeight: 400, letterSpacing: 0, lineHeight: 1.5, textAlign: "left", verticalAlign: "top" },
            { id: "logo", type: "logo", name: "logo", x: 48, y: 91, width: 431, height: 64, opacity: 1, zIndex: 2, objectFit: "contain", anchorX: "left" },
          ],
        },
      },
    },
  ...
  "split-mobile": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "title", type: "text", name: "title", x: 64, y: 147, width: 586, height: 183, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 72, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C" },
        ...
        square: {
          objects: [
            { id: "title", type: "text", name: "title", x: 59, y: 201, width: 429, height: 364, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 72, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C" },
        ...
        portrait: {
          objects: [
            ...
            { id: "title", type: "text", name: "title", x: 48, y: 395, width: 458, height: 531, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 72, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "left", verticalAlign: "bottom", color: "#F8AF3C" },
            { id: "description", type: "text", name: "description", x: 48, y: 944, width: 458, height: 899, opacity: 1, zIndex: 4, fontFamily: "Plus Jakarta Sans", fontSize: 32, fontWeight: 400, letterSpacing: 0, lineHeight: 1.5, textAlign: "left", verticalAlign: "top" },
            { id: "logo", type: "logo", name: "logo", x: 48, y: 200, width: 431, height: 64, opacity: 1, zIndex: 2, objectFit: "contain", anchorX: "left" },
          ],
        },
      },
    },
  ...
  "hero": {
    ...
    config: {
      ...
      formats: {
        landscape: {
          objects: [
            { id: "image", type: "image", name: "image", x: 0, y: 0, width: 1200, height: 675, opacity: 0.6, zIndex: 0, imageFrame: "none", objectFit: "cover", entrance: "none", exit: "none", kenBurns: true },
            { id: "title", type: "text", name: "title", x: 64, y: 393, width: 1072, height: 120, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 80, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "center", verticalAlign: "bottom", color: "#F8AF3C", textFit: true },
        ...
        square: {
          objects: [
            { id: "image", type: "image", name: "image", x: 0, y: 0, width: 1080, height: 1080, opacity: 0.6, zIndex: 0, imageFrame: "none", objectFit: "cover", entrance: "none", exit: "none", kenBurns: true },
            { id: "title", type: "text", name: "title", x: 80, y: 720, width: 920, height: 135, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 80, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "center", verticalAlign: "bottom", color: "#F8AF3C", textFit: true },
        ...
        portrait: {
          objects: [
            { id: "image", type: "image", name: "image", x: 0, y: 0, width: 1080, height: 1920, opacity: 0.6, zIndex: 0, imageFrame: "none", objectFit: "cover", entrance: "none", exit: "none", kenBurns: true },
            { id: "title", type: "text", name: "title", x: 76, y: 1422, width: 920, height: 134, opacity: 1, zIndex: 3, fontFamily: "Plus Jakarta Sans", fontSize: 80, fontWeight: 700, letterSpacing: 0, lineHeight: 1.2, textAlign: "center", verticalAlign: "bottom", color: "#F8AF3C", textFit: true },
            { id: "description", type: "text", name: "description", x: 140, y: 1579, width: 800, height: 239, opacity: 1, zIndex: 4, fontFamily: "Plus Jakarta Sans", fontSize: 48, fontWeight: 400, letterSpacing: 0, lineHeight: 1.2, textAlign: "center", verticalAlign: "top" },
            { id: "logo", type: "logo", name: "logo", x: 292, y: 1330, width: 497, height: 64, opacity: 1, zIndex: 2, objectFit: "contain" },
          ],
        },
      },
    },

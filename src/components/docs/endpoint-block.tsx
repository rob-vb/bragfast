    ...
    >
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-2.5 mb-3 sm:mb-4 flex-wrap">
          ...
          <code className="text-[13px] font-mono font-medium text-zinc-800 break-all">
            {endpoint.path}
          </code>
        </div>
        ...
        <p className="text-[15px] text-zinc-500 leading-relaxed mb-5 sm:mb-6">
      ...
      <div className="min-w-0 space-y-4 -mx-4 px-4 sm:mx-0 sm:px-0">
        ...
        <div>
          <h4 className="text-[11px] font-semibold uppercase tracking-wider text-zinc-400 mb-2">
            Response{" "}
            <span className="text-zinc-300 normal-case font-normal tracking-normal">

...
export const metadata: Metadata = {
  ...
  description:
    "Simple, predictable pricing. Images: 1 credit per slide. Videos: 15 credits per slide. Start free, scale as you grow.",
...
const FAQS = [
  {
    ...
    a: "Images cost 1 credit per slide per format. Videos cost 15 credits per slide per format. Example: 2 slides in 3 formats = 6 image credits or 90 video credits.",
  },
  {
      ...
      <section className="px-4 pt-16 pb-12 md:pt-24 md:pb-16 md:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="font-[family-name:var(--font-geist-sans)] text-base md:text-lg text-brand/70 leading-relaxed max-w-xl mx-auto">
            Images: 1 credit per slide. Videos: 15 credits per slide. Sign up and get{" "}

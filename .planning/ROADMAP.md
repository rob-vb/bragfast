...
- [x] 08-05-PLAN.md — Launch-mode collapse + admin sidebar trim + dashboard slim

**Wave 4** *(blocked on Wave 3)*

- [x] 08-06-PLAN.md — Billing reshape: single-price stripe.ts, plan union migration, account/upgrade pages
- [x] 08-07-PLAN.md — Gallery read-only (strip SocialCopySection) + new /admin/integrations page

# GitHub App Dashboard UI — Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add dashboard UI for installing, configuring, and monitoring the GitHub App integration — no AI, no approval flow (that's Plan B).
...
- `src/components/dashboard/github-section.tsx` — top-level client component for GitHub integration card
- `src/components/dashboard/github-repo-list.tsx` — repo list with merged config state
- `src/components/dashboard/github-repo-card.tsx` — per-repo config form
- `src/components/dashboard/github-skipped-log.tsx` — collapsible skipped releases table
...
- `src/app/(dashboard)/dashboard/account/page.tsx` — add GitHub Integration section
- `src/components/dashboard/history-table.tsx` — add GitHub source badge
- `src/components/dashboard/pixel-badge.tsx` — support arbitrary label + color
...
git commit -m "fix: redirect GitHub callback to /dashboard/account"
```
...
**Files:**
- Create: `src/components/dashboard/github-skipped-log.tsx`
...
```bash
git add src/components/dashboard/github-skipped-log.tsx
...
**Files:**
- Create: `src/components/dashboard/github-repo-card.tsx`
...
**Files:**
- Create: `src/components/dashboard/github-repo-list.tsx`
...
```bash
git add src/components/dashboard/github-repo-list.tsx
...
**Files:**
- Create: `src/components/dashboard/github-section.tsx`
...
```bash
git add src/components/dashboard/github-section.tsx
...
**Files:**
- Modify: `src/app/(dashboard)/dashboard/account/page.tsx`
...
**Files:**
- Modify: `src/components/dashboard/history-table.tsx`
...
```bash
git add src/components/dashboard/history-table.tsx
...
Run: `npx next dev`
Visit `/dashboard/account` — verify GitHub Integration section renders (shows install button if no installation).
